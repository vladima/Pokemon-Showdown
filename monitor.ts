...
class Monitor {
    connections: Dict<number> = {};
    connectionTimes: Dict<number> = {};
    battles: Dict<number> = {};
    battleTimes: Dict<number> = {};
    battlePreps: Dict<number> = {};
    battlePrepTimes: Dict<number> = {};
    groupChats: Dict<number> = {};
    groupChatTimes: Dict<number> = {};
    networkUse: Dict<number> = {};
    networkCount: Dict<number> = {};
    cmds: Dict<number> = {};
    cmdsTimes: Dict<number> = {};
    ...
    *********************************************************/
     ...
     */
    countConnection(ip: IpAddress, name: string) {
        let now = Date.now();
	 ...
	 */
    countBattle(ip: IpAddress, name: string) {
        let now = Date.now();
	 ...
	 */
    countCmd(ip: IpAddress, name: string) {
        let now = Date.now();
