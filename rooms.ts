...
namespace rooms {
    export const rooms: Dict<{}> = Object.create(null);
    export const aliases: Dict<{}> = Object.create(null);
    export class Room {
        id: RoomId;
        title: RoomTitle;
        reportJoins: {};
        users: Dict<User>;
        log: {}[];
        bannedUsers: Dict<User>;
        bannedIps: Dict<IpAddress>;
        muteQueue: {}[];
        muteTimer: {};
        
        constructor(roomid: RoomId, title: RoomTitle) {
            this.id = roomid;
